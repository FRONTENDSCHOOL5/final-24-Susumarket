...
const TopHeader = ({ type, username = null, onClickMore, disabled, headerText }) => {
  ...
  switch (type) {
    ...
    case "profileEdit":
      return <ProfileEditTopHeader disabled={disabled} onClickMore={onClickMore} headerText={headerText}/>;
    case "chat":
